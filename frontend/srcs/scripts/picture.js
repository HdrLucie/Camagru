...
(() => {
	...
	function startup() {
		...
		saveButton.addEventListener("click", () => {
			// Ajoutez ici votre logique pour sauvegarder la photo
			const photoData = photo.src;
			console.log("Saving photo:", photoData);
			// Exemple: sendToServer(photoData);
		});

		function toggleViews() {
			const isPhotoViewVisible = photoView.style.display === "block";
			photoView.style.display = isPhotoViewVisible ? "none" : "block";
			cameraView.style.display = isPhotoViewVisible ? "block" : "none";
		}
		...
		//	if (!streaming) {
		//		// Obtenir les dimensions réelles du conteneur parent
		...
		//
		//		// Si la hauteur calculée dépasse le conteneur, ajuster en fonction de la hauteur
		//		if (newHeight > containerHeight) {
		//			newHeight = containerHeight;
		//			newWidth = containerHeight * aspectRatio;
		//		}
		//
		//		// Appliquer les dimensions à la vidéo et au canvas
